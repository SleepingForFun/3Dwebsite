...
router.post('/add', function(req, res, next) {
    ...
    var n = req.session.cart.indexOf(req.body.product);
...
router.get('/checkout', function(req, res, next) {
    ...
    let insertquery = "INSERT INTO orderdetail(order_id, product_id, saleprice, prodqty) VALUES (?, ?, (SELECT saleprice from product where product_id = " + cartitem + "), ?)";
